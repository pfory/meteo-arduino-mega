...
$sel = "INSERT into dataSolar (DATETIME, IN, OUT, ROOM, STATUS) values ('".$datumCas->format('Y-m-d H:i:s')."',".$IN.",".$OUT.",".$ROOM.",".$status.")";
echo $sel;
$result = mysql_query("INSERT into dataSolar (DATETIME, IN, OUT, ROOM, STATUS) values ('".$datumCas->format('Y-m-d H:i:s')."',".$IN.",".$OUT.",".$ROOM.",".$status.")");
echo $result;
